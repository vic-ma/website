...
The goal of any crossword editor software is to make it as easy as possible to create a good crossword puzzle. To that end, one of the features that every crossword editor has is a [*word suggestion list*](https://gitlab.gnome.org/jrb/crosswords/-/raw/master/data/images/edit-grid.png). This is a list of words that fits the current slot. The list of words is generated by a *word suggestion algorithm*.
